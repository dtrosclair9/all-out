          ...
          <div className="lg:col-span-2">
            {formState === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#141414] border border-[#2a2a2a] focus:border-[#a60303] text-white font-body text-sm px-4 py-3 outline-none transition-colors duration-200 placeholder:text-[#888888]"
                    />
                  </div>
                  <div>
                ...
                <div>
                  <label htmlFor="field-email" className="block font-display text-xs tracking-widest uppercase text-[#888888] mb-2">
                    Email
                  </label>
                  <input
                    id="field-email"
                ...
                <div>
                  <label htmlFor="field-vehicle" className="block font-display text-xs tracking-widest uppercase text-[#888888] mb-2">
                    Year, Make &amp; Model{" "}
                    <span className="text-[#888888] normal-case font-body tracking-normal">(if applicable)</span>
                  </label>
                  <input
                    id="field-vehicle"
                    type="text"
                ...
                <div>
                  <label htmlFor="field-referral" className="block font-display text-xs tracking-widest uppercase text-[#888888] mb-2">
                    How Did You Find Us?{" "}
                    <span className="text-[#888888] normal-case font-body tracking-normal">(optional)</span>
                  </label>
                  <select
                    id="field-referral"
                    name="referral"
                ...
                <div>
                  <label htmlFor="field-message" className="block font-display text-xs tracking-widest uppercase text-[#888888] mb-2">
                    Additional Details
                  </label>
                  <textarea
                    id="field-message"
                    ...
                    className="w-full bg-[#141414] border border-[#2a2a2a] focus:border-[#a60303] text-white font-body text-sm px-4 py-3 outline-none transition-colors duration-200 placeholder:text-[#888888] resize-none"
                  />
                </div>
