    ...
    <>
      ...
      <section className="pt-32 pb-16 px-6 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto">
          <nav className="flex items-center gap-2 font-body text-xs text-[#888888] mb-6 flex-wrap">
            ...
            <span>/</span>
            <Link href="/services/marine-tinting" className="hover:text-[#f56565] transition-colors">Marine Tinting & Wraps</Link>
            <span>/</span>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            <h2 className="font-display text-white text-3xl md:text-4xl font-bold mb-6 leading-tight">
              BATON ROUGE BOATERS
              <br /><span className="text-[#f56565]">KNOW THE HEAT.</span>
            </h2>
      ...
      <section className="bg-[#0a0a0a] py-14 px-6 border-t border-[#242424]">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <Link href="/services/marine-tinting/gonzales" className="font-display tracking-widest uppercase border border-[#2a2a2a] hover:border-[#a60303] text-white hover:text-[#f56565] px-6 py-3 text-sm transition-colors duration-200 shrink-0">Gonzales Location →</Link>
        </div>
      </section>
