...
export const metadata: Metadata = {
  ...
  description:
    "Residential window tinting in Baton Rouge, LA. Reduce heat, cut energy costs & add privacy. Serving Central, Denham Springs & East Baton Rouge Parish. Call (225) 381-1000.",
};
