        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            <h2 className="font-display text-white text-3xl md:text-4xl font-bold mb-6 leading-tight">
              ...
              <br /><span className="text-[#E01818]">PROFESSIONAL TINT SHOP.</span>
            </h2>
            ...
            <div className="bg-[#141414] border border-[#242424] p-8 mb-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <a href="https://maps.google.com/?q=7987+Pecue+Lane,+Baton+Rouge,+LA+70809" target="_blank" rel="noopener noreferrer" className="font-body text-white text-sm hover:text-white transition-colors">
