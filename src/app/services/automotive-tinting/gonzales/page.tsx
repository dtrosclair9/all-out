    ...
    <>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            <h2 className="font-display text-white text-3xl md:text-4xl font-bold mb-6 leading-tight">
              GONZALES&apos; GO-TO
              <br /><span className="text-[#f56565]">WINDOW TINT SHOP.</span>
            </h2>
            ...
            <div className="bg-[#141414] border border-[#242424] p-8 mb-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <a href="https://maps.google.com/?q=43469+Cannon+Road,+Gonzales,+LA+70737" target="_blank" rel="noopener noreferrer" className="font-body text-white text-sm hover:text-[#f56565] transition-colors">
      ...
      <section className="bg-[#0a0a0a] py-14 px-6">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 border-t border-[#242424] pt-14">
          ...
          <Link href="/services/automotive-tinting/baton-rouge" className="font-display tracking-widest uppercase border border-[#2a2a2a] hover:border-[#a60303] text-white hover:text-[#f56565] px-6 py-3 text-sm transition-colors duration-200 shrink-0">
