...
export const metadata: Metadata = {
  ...
  description:
    "Commercial window tinting for storefronts, offices & fleets in Baton Rouge, LA. Serving East Baton Rouge Parish businesses. Reduce energy costs. Call (225) 381-1000.",
};
...
const schema = {
  ...
  url: "https://alloutwindowtint.com/services/commercial-tinting/baton-rouge",
};
