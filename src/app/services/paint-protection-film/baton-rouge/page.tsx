...
export const metadata: Metadata = {
  ...
  description:
    "PPF installation in Baton Rouge, LA. Self-healing paint protection film guards your finish against rock chips and road debris. Serving East Baton Rouge Parish. Call (225) 381-1000.",
};
