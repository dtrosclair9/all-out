    ...
    <>
          ...
          <div>
            <div className="space-y-6 mb-10">
              <div className="flex items-start gap-4">
                <svg className="w-5 h-5 text-[#f56565] mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="font-body text-white text-sm leading-relaxed hover:text-[#f56565] transition-colors"
                  >
                ...
                {services.map((s) => (
                  <li key={s.label}>
                    ...
                    >
                      ...
                      <span className="font-body text-[#888888] text-sm group-hover:text-[#f56565] transition-colors duration-200">
                        {s.label}
                      </span>
                    </Link>
                  </li>
      ...
      <section className="bg-[#0a0a0a] py-14 px-6">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            <p className="font-display text-[#f56565] tracking-widest uppercase text-xs mb-1">Also Serving</p>
          ...
          <Link
            ...
            className="font-display tracking-widest uppercase border border-[#2a2a2a] hover:border-[#a60303] text-white hover:text-[#f56565] px-6 py-3 text-sm transition-colors duration-200 shrink-0"
          >
            View Location
          </Link>
        </div>
