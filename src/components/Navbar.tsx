        ...
        <div className="hidden md:flex items-center gap-8">
          <ul className="flex items-center gap-8">
            <li>
              <Link
                href="/"
                className="font-display text-sm tracking-widest uppercase text-white/80 hover:text-white transition-colors duration-200"
              >
                Home
              </Link>
            </li>
            ...
            <li className="relative" ref={dropdownRef}>
              <button
                ...
                className="font-display text-sm tracking-widest uppercase text-white/80 hover:text-white transition-colors duration-200 flex items-center gap-1"
              >
                Services
                <svg
              ...
              {servicesOpen && (
                <div className="absolute top-full left-1/2 -translate-x-1/2 mt-3 w-56 bg-[#0a0a0a] border border-[#242424] shadow-xl shadow-black/60 z-50">
                  ...
                  <Link
                    href="/services"
                    onClick={() => setServicesOpen(false)}
                    className="block font-display text-xs tracking-widest uppercase text-white hover:bg-[#141414] px-5 py-3 transition-colors duration-150"
                  >
                    All Services →
                  </Link>
                </div>
        ...
        <ul className="px-6 pb-6 flex flex-col gap-4 border-t border-white/10 pt-4">
          <li>
            <Link
              ...
              className="block font-display text-sm tracking-widest uppercase text-white/80 hover:text-white transition-colors"
            >
              Home
            </Link>
          </li>
          ...
          <li>
            <button
              ...
              className="w-full flex items-center justify-between font-display text-sm tracking-widest uppercase text-white/80 hover:text-white transition-colors"
            >
              Services
              <svg
              ...
              <ul className="pl-4 flex flex-col gap-3 border-l border-[#a60303]/40">
                {serviceLinks.map((link) => (
                  <li key={link.href}>
                    <Link
                      ...
                      className="block font-display text-xs tracking-widest uppercase text-white/60 hover:text-white transition-colors"
                    >
                      {link.label}
                    </Link>
                  </li>
                ...
                <li>
                  <Link
                    href="/services"
                    onClick={() => { setMenuOpen(false); setMobileServicesOpen(false); }}
                    className="block font-display text-xs tracking-widest uppercase text-white transition-colors"
                  >
                    All Services →
                  </Link>
                </li>
