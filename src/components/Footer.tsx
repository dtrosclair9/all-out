      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={s.label}>
                  <Link
                    href={s.href}
                    className="text-[#888888] hover:text-white text-sm transition-colors font-body"
                  >
                    {s.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-5">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <Link href="/locations/gonzales" className="text-white text-xs font-display tracking-wider uppercase hover:text-white transition-colors">Gonzales</Link>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <Link href="/locations/baton-rouge" className="text-white text-xs font-display tracking-wider uppercase hover:text-white transition-colors">Baton Rouge</Link>
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:2252519184" className="text-[#888888] hover:text-white text-sm transition-colors font-body">(225) 251-9184</a>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-4 h-4 text-[#E01818] shrink-0" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex gap-3 mt-6">
              <a
                ...
                className="w-9 h-9 border border-[#242424] flex items-center justify-center text-[#888888] hover:border-[#a60303] hover:text-white transition-colors"
                aria-label="Facebook"
              >
        ...
        <div className="mt-12 pt-6 border-t border-[#242424] flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4">
            <Link href="/privacy" className="text-[#888888] hover:text-white text-xs font-body transition-colors duration-200">
              Privacy Policy
            </Link>
